...
namespace WPEFramework
{
    namespace Plugin
    {
        ...
        wifiManager::~wifiManager() {
            ...
            g_main_context_pop_thread_default(wifiContext);
            g_main_context_unref(wifiContext);
            g_object_unref(client);
        }

        wifiManager::wifiManager() : client(nullptr), loop(nullptr), createNewConnection(false) {
            wifiContext = g_main_context_new();
            g_main_context_push_thread_default(wifiContext);
            loop = g_main_loop_new(wifiContext, FALSE);
        }
